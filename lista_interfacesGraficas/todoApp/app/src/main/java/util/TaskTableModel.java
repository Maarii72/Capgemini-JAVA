...
public class TaskTableModel extends AbstractTableModel {
    ...
    String[] columns = {"Nome", "Descrição", "Prazo", "Tarefa Concluída", "Editar", "Excluir"};//definição colunas
    List<Task> tasks = new ArrayList();//definição lista de tarefas

    @Override // 3 métodos obrigatórios
